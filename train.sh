#UNET
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 --master_port=1249 train.py --launcher pytorch --max_iter 11 --loss_l1  --net_name UNET --name std8_15_fastmri_UNET --trainset FastMRITrainSet
...
#可以运行的代码
python train.py --gpu_ids 1 --launcher none --loss_l1 --modal T1 --data_augmentation --lr 1e-4 --net_name UNET
