...
def main():
    ...
    ## dataloader setting
    parser.add_argument('--traindata_root', default='/home/M4Raw-main/data/M4quick_test/M4RawV1.5/M4RawV1.5_multicoil_train/multicoil_train', type=str)
    parser.add_argument('--testdata_root', default='/home/M4Raw-main/data/M4quick_test/M4RawV1.5/M4Raw_multicoil_test/multicoil_test', type=str)
    ...
    parser.add_argument('--max_iter', default=50, type=int)#####这个就是训练轮数
    ...
    parser.add_argument('--gan_type', default='LSGAN', type=str)####LSGAN,DCGAN，WGAN_GP
    ...
    parser.add_argument('--save_folder', default='./M4Raw_experiment', type=str)
