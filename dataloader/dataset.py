...
args = {
    'traindata_root': "/home/M4Raw-main/data/M4quick_test/M4RawV1.5/M4RawV1.5_multicoil_train/multicoil_train",
    'testdata_root': "/home/M4Raw-main/data/M4quick_test/M4RawV1.5/M4Raw_multicoil_test/multicoil_test",
    'val_modal': '/home/M4Raw-main/data/M4quick_test/M4RawV1.5/M4RawV1.5_multicoil_val/multicoil_val'  # 如果需要其他参数，可以像这样添加
}
class TrainSet(Dataset):
    def __init__(self, args):
        ...
        for i in range(1,10):
            ...
            input_list = sorted(glob.glob(os.path.join(args.traindata_root, '*_{}0{}.h5'.format(args.modal, i))))
            # print(f"Found files: {input_list}")  # 检查是否找到文件
            if len(input_list)>0:
...
class TestSet(Dataset):
    def __init__(self, args):
        ...
        for i in range(1,10):
            ...
            input_list = sorted(glob.glob(os.path.join(args.testdata_root, '*_{}0{}.h5'.format(args.modal, i))))
            # print(f"Found files: {input_list}")  # 检查是否找到文件
            if len(input_list)>0:
